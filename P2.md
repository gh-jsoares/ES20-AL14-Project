...
#### Controllers (FIX LINKS)
 - [StudentQuestionController](backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/question/api/StudentQuestionController.java)

### Feature testing (FIX LINKS)

Each subgroup member defined one reading test and one writing test. The direct links to these are:

 - [WSGetAllStudentQuestionAsTeacherTest.jmx](backend/jmeter/studentquestion/WSGetAllStudentQuestionAsTeacherTest.jmx)
 - [WSCreateStudentQuestionTest.jmx](backend/jmeter/studentquestion/WSCreateStudentQuestionTest.jmx)


#### Screenshots of Results Trees and DB cleanup

![Response body](backend/jmeter/studentquestion/pictures/WSCreateStudentQuestionTest/results.png)
![Summary report](backend/jmeter/studentquestion/pictures/WSCreateStudentQuestionTest/summary.png)
![DB Cleanup](backend/jmeter/studentquestion/pictures/WSCreateStudentQuestionTest/cleanup.png)


### Load testing (FIX LINKS)

Each subgroup member defined one reading test and one writing test. The direct links to these are:

 - [WSGetAllStudentQuestionAsTeacherLoadTest.jmx](backend/jmeter/studentquestion/WSGetAllStudentQuestionAsTeacherLoadTest.jmx)
 - [WSCreateStudentQuestionLoadTest.jmx](backend/jmeter/studentquestion/WSCreateStudentQuestionLoadTest.jmx)


#### Screenshots of Summary Reports and DB cleanup (WSGetAllStudentQuestionAsTeacherLoadTest)

![Summary report](backend/jmeter/studentquestion/pictures/WSCreateStudentQuestionLoadTest/summary.png)
![DB Cleanup](backend/jmeter/studentquestion/pictures/WSCreateStudentQuestionLoadTest/cleanup.png)
...
![Profiling percentages](backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/question/service/studentquestions/performance/snapshots/CreateStudentQuestionPerformanceSpockTest/Profiler.png)
![Profiling graphs](backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/question/service/studentquestions/performance/snapshots/CreateStudentQuestionPerformanceSpockTest/Monitor.png)
![Profiling heap](backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/question/service/studentquestions/performance/snapshots/CreateStudentQuestionPerformanceSpockTest/Memory.png)
