...
#### Feature number 1: _O aluno pode pedir esclarecimentos adicionais_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_14-project/blob/DdP-G2/frontend/tests/e2e/specs/discussion/makeNewQuestion.js)
   + Screenshot: 
...
#### Feature number 5: _O aluno decide se esta informação no seu dashboard deve ser pública ou privada_ 
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_14-project/blob/DdP-G1/frontend/tests/e2e/specs/dashboard/toggleDiscussionPrivacy.js)
   + Screenshot: 
