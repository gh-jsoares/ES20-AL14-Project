...
@DataJpaTest
class StudentGetStudentQuestionPerformanceSpockTest extends Specification {
    ...
    def "get AMOUNT_OF_QUESTIONS student questions AMOUNT_OF_TESTS times"() {
        ...
        when:
        0.upto(AMOUNT_OF_QUESTIONS, {
            studentQuestionService.getStudentQuestion(user.getId(), it.intValue() + 1)
            print("\nTEST NUMBER: $it\n")
        })
