...
@DataJpaTest
class TeacherRejectStudentQuestionPerformanceSpockTest extends Specification {

    public static final int AMOUNT_OF_QUESTIONS = 1 // 100000
    ...
    public static final String REJECT_EXPLANATION = "No bueno"
    ...
    def "approve AMOUNT_OF_QUESTIONS student questions"() {
        ...
        when:
        0.upto(AMOUNT_OF_QUESTIONS, {
            studentQuestionService.rejectStudentQuestion(teacher.getId(), it.intValue() + 1, REJECT_EXPLANATION)
            print("\nTEST NUMBER: $it\n")
        })
