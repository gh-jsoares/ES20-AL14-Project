        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "DISCUSSION.ACCESS":
                    return userHasAnExecutionOfTheCourse(userId, discussionService.findDiscussionCourse(id).getCourseId());
                case "TOPIC.ACCESS":
                ...
                case "STUDENTQUESTION.ACCESS":
                    return studentQuestionService.canAccessStudentQuestion(userId, id);
